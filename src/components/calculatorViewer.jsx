...
function calculatorViewer() {
  return (
    <div className="flex h-full w-full p-3 dark:bg-gray-900">
        ...
        <div className="drop-shadow-xl h-full w-full overflow-hidden">
          <div className="absolute flex items-center justify-center text-white z-[1]">
            <div className="h-full w-full flex items-center justify-center">
              <div className="relative w-full max-w-2xl my-8 md:my-16 flex flex-col items-start space-y-4 sm:flex-row sm:space-y-0 sm:space-x-6 px-4 py-8 border-2 border-gray-400 dark:border-gray-400 shadow-lg rounded-lg">
                ...
                <div className="w-full sm:w-auto flex flex-col items-center sm:items-start">
                  ...
                  <div className="mb-4 md:text-lg text-gray-400">
                    <p>
                      Prajwal is a versatile content writer with a strong
